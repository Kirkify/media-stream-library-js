...
const clock_1 = __importDefault(require("../../utils/clock"));
 ...
 * @extends {Component}
 */
class CanvasSink extends component_1.Sink {
    /**
    ...
    constructor(el) {
        ...
        const scheduler = new scheduler_1.default(clock, drawImageBlob);
        ...
        const incoming = new stream_1.Writable({
            ...
            write: (msg, encoding, callback) => {
                ...
                else if (msg.type === message_1.MessageType.JPEG) {
